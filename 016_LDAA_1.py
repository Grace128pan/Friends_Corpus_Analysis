...
# Save LDA model
lda_model.save(os.path.join(analysis_folder, 'lda_model'))

# Visualize the LDA results
vis = pyLDAvis.gensim_models.prepare(lda_model, corpus, dictionary)
pyLDAvis.save_html(vis, os.path.join(analysis_folder, 'lda_visualization.html'))

print(f"LDA analysis results saved to: {analysis_folder}")
