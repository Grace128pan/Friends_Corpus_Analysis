...
# File path
chandler_lines_file_path = r'C:\Users\grace\Desktop\Analysis\Character_Lines\Chandler_lines.txt'
output_path = r'C:\Users\grace\Desktop\Analysis\chandler_word_frequency_plot.png'
...
# Read Chandler's lines
with open(chandler_lines_file_path, 'r', encoding='utf-8') as file:
    chandler_lines = file.read()

# Tokenize the text
tokens = clean_and_tokenize(chandler_lines)
...
plt.title('Top 80 Word Frequency Distribution for Chandler (Words > 6 letters)')
plt.xlabel('Words')
...
# File path
chandler_lines_file_path = r'C:\Users\grace\Desktop\Analysis\Character_Lines\Chandler_lines.txt'
output_path = r'C:\Users\grace\Desktop\Analysis\chandler_wordcloud.png'
...
exclude_words = set(
    ...
    ["wan", "na", "gon", "na", "dont", "yes", "guy", "helen", "guys"]
)
...
plt.title('Word Cloud for Chandler (Excluding Specified Words)')
plt.axis('off')
plt.tight_layout()
